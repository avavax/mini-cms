    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            ...
            <div class="col-xl-6 text-right">
                <a href="/admin/articles/add"><button>Добавить статью</button></a>
            </div>
            <div class="col-12">
                <table class="table">
                    <tr>
                    ...
                    <tr>
                        <td><?= $preview['id'] ?></td>
                        <td>
                            <a href="/admin/articles/edit/<?= $preview['id'] ?>">
                                <?= $preview['title'] ?>
                            </a>
                        </td>
                        <td>
                        ...
                        <td><?= $preview['excerpt'] ?></td>
                        <td class="text-center"><?= $preview['comments'] ?></td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Вы точно хотите удалить статью?</h5>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="/admin/articles/delete/<?= $preview['id'] ?>">
